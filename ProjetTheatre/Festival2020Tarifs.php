<!DOCTYPE html>
		...
		<body>
			...
			<!-- Menu de navigation du site -->
				...
				<ul class="navbar">
					...
					<div id="vignette">						
							<a href="index.php">
								<img class="vignette" src="images/logo.jpg" alt="[logo de l'association vers l'accueil du site]"
									width=30%
									height=30%
									decoding=low
								>
				...
				<ul class="navbar">
					La page &#8239;:		  		
					<li><a href="#label_Prose">Prose</a></li>
					<li><a href="#label_Philosophie">Philosophie</a></li>
		...
		<main>
			<div class="decalage">
				...
				</section> <!-- Présentation des tarifs --> <!--"bloc_bleu" -->
				
				<section class ="bloc_bleu"><!-- Explication des tarifs -->
						...
						<section><!-- qualité des spectacles et des lieux -->	
							...
							<h1 id="label_Contexte"> 	Notre contexte tarifaire </h1>
								<h2> 	Théâtres de Bourbon est une association à but non lucratif </h2>
									<p>
										<img  	class="vignette" src="images/logo.png" alt="[logo de l'association]"
											width=20%
											height=20%
											decoding=low
										>		
							...
							<section ><!--Financeurs-->
									...
									<p> Communauté de commune de Saint Pourcain la Sioule
										<div> 
											<a href="http://www.comcompayssaintpourcinois.fr" target="_blank" rel="noopener noreferrer">
												<img src="images/imgSponsorLogoCommunauteCommune.jpg" alt="[ LogoCommunautéDeCommune]"
													width=50%
													height=50%
													decoding=low
												> 
								...
								<p> Centre National du costume de scène Moulins
									<div> 
										<a href="http://www.www.cncs.fr" target="_blank" rel="noopener noreferrer">
											<img src="images/imgLogoCNCS.jpg" alt="[ LogoCNCS]"
												width=50%
												height=50%
				...
				<footer>
				Tarifs  <address>Page conçue par Kevin HUART et Mathilde VERRIEZ CHASTANG</address>
				</footer>
