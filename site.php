 ...
 <html>
	...
	<body>
		...
		<ul class="navbar">
			...
			<li><a href="Festival2018ProgrammationParJour.php">Jour par Jour</a></li>
			<li><a href="Festival2018ProgrammationParLieu.php">Lieu par Lieu</a></li>
			<li><a href="Festival2018ProgrammationParSpectacle.php">Spectacles</a></li>
			<li><a href="Festival2019Tarifs.php">Tarifs</a> </li>
			...
			<ul class="navbar">
				...
				<li>
					<a href="#label_association"> L'association
					</a>	
				</li>

				<li> 
					<a href="#label_devenirMembre">Devenir membre
					</a>	
				</li>

				<li>
					<a href="#label_faireUnDon">Faire un don
					</a>
				</li>

				<li> 
					<a href="#label_contact">Nous contacter
					</a>
				</li>	
...
<div id="ContenantVignetteP">
		...
		<main>
			<div class="decalage">
				...
				<img
							src="images/imgLieuLachaise2.jpg"
							alt="[photo De Lachaise]"
							width=20%
							height=20%
				...
				<img
							src="images/imgLieuLachaise3.jpg"
							alt="[photo entrée Lachaise]"
							width=17%
							height=17%
							decoding=low
					>
...
Pourquoi une carte blanche à une toute jeune troupe dans le cadre de ce festival ?
	...
	<!-- Signer et dater la page, c'est une question de politesse! -->
		<address>Page conçue par Sylvie Delaët 25 novembre 2018, textes Pierre Deusy.</address>
